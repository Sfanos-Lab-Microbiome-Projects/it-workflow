...
#SBATCH --job-name="P16-convert-tax-class"
#SBATCH --mem=6G
#SBATCH -p lrgmem
#SBATCH --array=1-6
...
echo "$REGION"
outDir=../analysis/P16-convert-tax-class

qiime tools export \
  --input-path ../analysis/P15-clust-tree-cm-goods/$REGION/table.qza \
...
perl -pe "s/Feature ID\tTaxon\tConsensus/#OTUID\ttaxonomy\tconfidence/g" ../analysis/P15-clust-tree-cm-goods/$REGION/tax-class/taxonomy.tsv > $outDir/$REGION/exported-feature-table/t.txt
