...
use Data::Dumper;
# ------------------------
my $outDir = "../analysis/P07-filtered-sum-taxa-db4.0";
`rm -r $outDir`;
`mkdir $outDir`;
...
foreach my $v (@regions){
  ...
  my $file = "../analysis/P06-filtered-convert-tax-class/$v/exported-feature-table/feature-table.biom";
  my $tx   = "../analysis/P06-filtered-convert-tax-class/$v/taxonomy.tsv";
  # ------------------------
  # convert to tsv --
