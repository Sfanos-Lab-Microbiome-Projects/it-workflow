...
#SBATCH --job-name="P06-filtered-convert-tax-class"
#SBATCH --mem=6G
#SBATCH -p lrgmem
#SBATCH --array=1-6
...
echo "$REGION"
outDir=../analysis/P06-filtered-convert-tax-class

qiime tools export \
  --input-path ../analysis/P05-clust-tree-cm-goods/$REGION/$REGION-filtered-table.qza \
