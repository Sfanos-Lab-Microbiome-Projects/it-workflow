...
use Data::Dumper;
# ------------------------
my $outDir = "../analysis/P17-sum-taxa-db4.0.pl";
`rm -r $outDir`;
`mkdir $outDir`;
...
foreach my $v (@regions){
  ...
  my $file = "../analysis/P16-convert-tax-class/$v/exported-feature-table/feature-table.biom";
  my $tx   = "../analysis/P16-convert-tax-class/$v/taxonomy.tsv";
  # ------------------------
  # convert to tsv --
